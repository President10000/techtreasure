            ...
            <div className="main-product-details">
              ...
              <div className=" py-3 ">
                ...
                <div className="d-flex align-items-center  gap-15 flex-row  mt-2 mb-3">
                  ...
                  <div className="d-flex align-items-center gap-10  ">
                    {["Buy Now", "Add to Cart"].map((item, i) => {
                      return (
                        <button
                          key={i}
                          className="border-0 rounded-2 fs-6 px-2 py-1"
                          type="submit"
                        >
                          {item}
                        </button>
                ...
                <div className="d-flex align-items-center  gap-15">
                  {
                    [{Comp:IoGitCompare,text:'Add to Compare'},{Comp:AiOutlineHeart,text:'Add to Wishlist'}].map((item,i)=>{
                      return                   <div key={i}>
                      {" "}
                      <a href="#" className="d-flex flex-column flex-md-row justify-content-center align-items-center gap-2">
                        <item.Comp className="fs-5 me-2" /> <span>{item.text}</span>
                      </a>
                    </div>
                    })
                  }
