...
const Search = () => {
  ...
  const refresh = useSelector((state) => state.productBycategory.refresh); // when only query changes react components does not rerender automatically, so to rerender this components refresh is required
  useEffect(() => {
