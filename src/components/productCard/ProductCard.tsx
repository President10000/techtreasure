...
import { addOrRemoveWish, filter_wishlist, push_wishlist } from "../../features/wishlist/wishlistSlice";
  ...
  return (
    <>
      {productdata?.map((item, i) => {
        ...
        return (
          <div key={i} className={`gr-${grid} individual-product  position-relative`}>
